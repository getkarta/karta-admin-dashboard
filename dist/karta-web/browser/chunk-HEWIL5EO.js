import {
  ...
  uniq_default,
  values_default
} from "./chunk-4MD7JHFY.js";
import {
  isEmpty_default
} from "./chunk-U53DVM5X.js";
import {
  identity_default,
  isArray_default,
  isFunction_default,
  isObject_default
} from "./chunk-RU5GTINO.js";
import {
  __async,
  __commonJS,
  __export,
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/rest.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/first.js
function first(prod) {
  if (prod instanceof NonTerminal) {
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/constants.js
var IN = "_~IN~_";

// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/follow.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/reg_exp_parser.js
var regExpAstCache = {};
var regExpParser = new RegExpParser();
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/reg_exp.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/lexer.js
var PATTERN = "PATTERN";
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/tokens.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/lexer_errors_public.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/lexer_public.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/scan/tokens_public.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/errors_public.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/resolver.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/interpreter.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/lookahead.js
var PROD_TYPE;
(function(PROD_TYPE2) {
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/checks.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/gast/gast_resolver_public.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/exceptions_public.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/recoverable.js
var EOF_FOLLOW_KEY = {};
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/keys.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/grammar/llk_lookahead.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/looksahead.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/cst/cst.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/lang/lang_extensions.js
var NAME = "name";
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/cst/cst_visitor.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/tree_builder.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/lexer_adapter.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/recognizer_api.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/recognizer_engine.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/error_handler.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/context_assist.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/gast_recorder.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/traits/perf_tracer.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/utils/apply_mixins.js
...
// node_modules/langium/node_modules/chevrotain/lib/src/parse/parser/parser.js
...
// node_modules/langium/node_modules/chevrotain-allstar/lib/atn.js
...
// node_modules/langium/node_modules/chevrotain-allstar/lib/dfa.js
var DFA_ERROR = {};
...
// node_modules/langium/node_modules/chevrotain-allstar/lib/all-star-lookahead.js
  ...
  validateAstBefore(_0, _1, _2) {
    return __async(this, arguments, function* (rootNode, options, acceptor, cancelToken = cancellation_exports.CancellationToken.None) {
      ...
      for (const checkBefore of checksBefore) {
        yield interruptAndCheck(cancelToken);
        yield checkBefore(rootNode, acceptor, (_a = options.categories) !== null && _a !== void 0 ? _a : [], cancelToken);
      }
    });
  }
  validateAstNodes(_0, _1, _2) {
    return __async(this, arguments, function* (rootNode, options, acceptor, cancelToken = cancellation_exports.CancellationToken.None) {
      yield Promise.all(streamAst(rootNode).map((node) => __async(this, null, function* () {
        yield interruptAndCheck(cancelToken);
  ...
  validateAstAfter(_0, _1, _2) {
    return __async(this, arguments, function* (rootNode, options, acceptor, cancelToken = cancellation_exports.CancellationToken.None) {
      ...
      for (const checkAfter of checksAfter) {
        yield interruptAndCheck(cancelToken);
        yield checkAfter(rootNode, acceptor, (_a = options.categories) !== null && _a !== void 0 ? _a : [], cancelToken);
      }
    });
  }
...
var DefaultDocumentBuilder = class {
  ...
  update(_0, _1) {
    return __async(this, arguments, function* (changed, deleted, cancelToken = cancellation_exports.CancellationToken.None) {
      ...
      yield this.emitUpdate(changed, deleted);
      yield interruptAndCheck(cancelToken);
  ...
  buildDocuments(documents, options, cancelToken) {
    return __async(this, null, function* () {
      ...
      yield this.runCancelable(documents, DocumentState.ComputedScopes, cancelToken, (doc) => __async(this, null, function* () {
        ...
        doc.precomputedScopes = yield scopeComputation.computeLocalScopes(doc, cancelToken);
      }));
      yield this.runCancelable(documents, DocumentState.Linked, cancelToken, (doc) => {
        const linker = this.serviceRegistry.getServices(doc.uri).references.Linker;
        return linker.link(doc, cancelToken);
      });
      yield this.runCancelable(documents, DocumentState.IndexedReferences, cancelToken, (doc) => this.indexManager.updateReferences(doc, cancelToken));
      const toBeValidated = documents.filter((doc) => this.shouldValidate(doc));
      yield this.runCancelable(toBeValidated, DocumentState.Validated, cancelToken, (doc) => this.validate(doc, cancelToken));
  ...
  validate(document, cancelToken) {
    return __async(this, null, function* () {
      ...
      const diagnostics = yield validator.validateDocument(document, options, cancelToken);
...
var DefaultIndexManager = class {
  ...
  updateContent(_0) {
    return __async(this, arguments, function* (document, cancelToken = cancellation_exports.CancellationToken.None) {
      ...
      const exports = yield services.references.ScopeComputation.computeExports(document, cancelToken);
...
var DefaultWorkspaceManager = class {
  ...
  performStartup(folders) {
    return __async(this, null, function* () {
      ...
      yield Promise.all(folders.map((wf) => [wf, this.getRootFolder(wf)]).map((entry) => __async(this, null, function* () {
        return this.traverseFolder(...entry, fileExtensions, collector);
      })));
      this._ready.resolve();
      return documents;
    });
   ...
   */
  traverseFolder(workspaceFolder, folderPath, fileExtensions, collector) {
    return __async(this, null, function* () {
      ...
      yield Promise.all(content.map((entry) => __async(this, null, function* () {
        if (this.includeEntry(workspaceFolder, entry, fileExtensions)) {
          if (entry.isDirectory) {
            yield this.traverseFolder(workspaceFolder, entry.uri, fileExtensions, collector);
          } else if (entry.isFile) {
            const document = yield this.langiumDocuments.getOrCreateDocument(entry.uri);
            collector(document);
          }
        }
      })));
...
//# sourceMappingURL=chunk-HEWIL5EO.js.map

...
var drawActors = /* @__PURE__ */ __name(function(diagram2, actors, actorKeys, isFooter) {
  return __async(this, null, function* () {
    if (!isFooter) {
      for (const actorKey of actorKeys) {
        const actor = actors.get(actorKey);
...
//# sourceMappingURL=chunk-2G3DILTA.js.map
